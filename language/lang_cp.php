...
$_SGLOBAL['cplang'] = array(
	...
	'feed_comment_quiz' => '{actor} 评论了 {touser} 的打赌 {quiz}',
	...
	'note_quiz_comment' => '评论了你的打赌 <a href="\\1" target="_blank">\\2</a>',
	'note_quiz_comment_reply' => '回复了你的<a href="\\1" target="_blank">打赌评论</a>',
	...
	'note_show_out' => '访问了你的主页后，你在竞价排名榜中最后一个打赌也被消费掉了',
	'note_space_bar' => '把你设置为站点推荐用户了',

	'note_click_blog' => '对你的日志 <a href="\\1" target="_blank">\\2</a> 做了表态',
	'note_click_quiz' => '对你的打赌 <a href="\\1" target="_blank">\\2</a> 做了表态',
	...
	'note_showcredit' => '赠送给您 \\1 个竞价打赌，帮助提升在<a href="space.php?do=top" target="_blank">竞价排行榜</a>中的名次',
	'feed_showcredit' => '{actor} 赠送给 {fusername} 竞价打赌 {credit} 个，帮助好友提升在<a href="space.php?do=top" target="_blank">竞价排行榜</a>中的名次',
	'feed_showcredit_self' => '{actor} 增加竞价打赌 {credit} 个，提升自己在<a href="space.php?do=top" target="_blank">竞价排行榜</a>中的名次',
	'feed_doing_title' => '{actor}：{message}',
	'note_doing_reply' => '在<a href="\\1" target="_blank">心情</a>中对你进行了回复',
	'feed_friend_title' => '{actor} 和 {touser} 成为了好友',
	'note_friend_add' => '和你成为了好友',
	'note_poll_invite' => '邀请你一起参与 <a href="\\1" target="_blank">《\\2》</a>的\\3投票',
	'note_quiz_invite' => '邀请你一起参与 <a href="\\1" target="_blank">《\\2》</a>的\\3打赌',
	'note_quiz_join' => '我参与了 <a href="\\1" target="_blank">《\\2》</a>的\\3打赌，你也快来吧',
	'note_quiz_win' => '恭喜你在 <a href="\\1" target="_blank">《\\2》</a>的\\3打赌中得胜，获得金币\\4。',
	'note_quiz_invalid' => '由于你参加的 <a href="\\1" target="_blank">《\\2》</a>\\3打赌没有正确答案，返还金币\\4。',
	'note_quiz_lost' => '很不幸你在 <a href="\\1" target="_blank">《\\2》</a>的\\3打赌中没有获胜，输了打赌\\4，请继续努力o~下次得奖的就是你！',
	'note_quiz_remind' => '温馨提示：你的<a href="\\1" target="_blank">《\\2》</a>的打赌将在1小时后到期，请及时公布答案.',
	'note_quiz_exceed' => '由于你的<a href="\\1" target="_blank">《\\2》</a>打赌由于超期没有公布答案，已被取消并扣除你的信用\\3。',
	'note_quiz_exceed2' => '你所参与的<a href="\\1" target="_blank">《\\2》</a>打赌由于超期没有公布答案，已被取消并返还你的投注金币\\3。',
	'reward' => '悬赏',
	'reward_info' => '参与投票可获得  \\1 打赌',
	'poll_separator' => '"、"',
	...
	'quiz_comment' => '<a href="\\2" target="_blank">\\1 评论了你的打赌</a>',
	...
	'quiz_comment_reply' => '\\1 回复了你的打赌评论',
	...
	'share_quiz' => '分享了一篇打赌',
	'note_share_quiz' => '分享了你的打赌 <a href="\\1" target="_blank">\\2</a>',
	'share_album' => '分享了一个相册',
	...
	'feed_task_credit' => '{actor} 完成了有奖任务 {task}，领取了 {credit} 个奖励打赌',
	...
	'feed_quiz_password' => '{actor} 发表了新加密打赌 {subject}',
	'feed_quiz' => '{actor} 发表了新打赌',
	...
	'take_part_in_the_quiz' => '{actor} 参与了 {touser} 的{reward}打赌 <a href="{url}" target="_blank">{subject}</a>',
	'publish_key_in_the_quiz' => '{actor} 公布了打赌 <a href="{url}" target="_blank">{subject}</a>的答案，答案是{key}',
	'publish_key_in_the_quiz2' => '{actor} 公布了打赌 <a href="{url}" target="_blank">{subject}</a>的答案，本期打赌流失，所有金币已返还给参与用户。',
	'publish_key_in_the_quiz3' => '{actor} 公布了打赌 <a href="{url}" target="_blank">{subject}</a>的答案，答案是{key}.<br><br><br>参与人数{attend}人,中奖人数 {win}人，每人获得奖池{precost}金币<br>恭喜{touser}成为本次打赌的大赢家',
	'publish_key_in_the_quiz4' => '{actor} 公布了打赌 <a href="{url}" target="_blank">{subject}</a>的答案，答案是{key}.<br><br><br>参与人数{attend}人,很不幸本期没有人获胜，大家要加油哟！',
	...
	'feed_add_attachsize' => '{actor} 用 {credit} 个打赌兑换了 {size} 附件空间，可以上传更多的图片啦(<a href="cp.php?ac=credit&op=addsize">我也来兑换</a>)',
