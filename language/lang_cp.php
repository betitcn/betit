...
$_SGLOBAL['cplang'] = array(
	...
	'feed_comment_quiz' => '{actor} 评论了 {touser} 的竞猜 {quiz}',
	...
	'note_quiz_comment' => '评论了你的竞猜 <a href="\\1" target="_blank">\\2</a>',
	'note_quiz_comment_reply' => '回复了你的<a href="\\1" target="_blank">竞猜评论</a>',
	...
	'note_show_out' => '访问了你的主页后，你在竞价排名榜中最后一个竞猜也被消费掉了',
	'note_space_bar' => '把你设置为站点推荐用户了',

	'note_click_blog' => '对你的日志 <a href="\\1" target="_blank">\\2</a> 做了表态',
	'note_click_quiz' => '对你的竞猜 <a href="\\1" target="_blank">\\2</a> 做了表态',
	...
	'note_showcredit' => '赠送给您 \\1 个竞价竞猜，帮助提升在<a href="space.php?do=top" target="_blank">竞价排行榜</a>中的名次',
	'feed_showcredit' => '{actor} 赠送给 {fusername} 竞价竞猜 {credit} 个，帮助好友提升在<a href="space.php?do=top" target="_blank">竞价排行榜</a>中的名次',
	'feed_showcredit_self' => '{actor} 增加竞价竞猜 {credit} 个，提升自己在<a href="space.php?do=top" target="_blank">竞价排行榜</a>中的名次',
	...
	'note_quiz_invite' => '邀请你一起参与 <a href="\\1" target="_blank">《\\2》</a>的\\3竞猜',
	...
	'note_quiz_remind' => '温馨提示：你的<a href="\\1" target="_blank">《\\2》</a>的竞猜已经过期，请在一天内及时公布答案.',
	'note_quiz_remind2' => '温馨提示：你所转发的<a href="\\1" target="_blank">《\\2》</a>的竞猜已经过期，请随时留意<a href="\\3" target="_blank">原竞猜</a>的公布答案情况。',
	'note_quiz_exceed3' => '你所转发的<a href="\\1" target="_blank">《\\2》</a>竞猜由于<a href="\\3" target="_blank">原竞猜</a>超期没有公布答案，已被取消并返还你的投注金币。',
	...
	'quiz_comment' => '<a href="\\2" target="_blank">\\1 评论了你的竞猜</a>',
	...
	'quiz_comment_reply' => '\\1 回复了你的竞猜评论',
	...
	'share_quiz' => '分享了一篇竞猜',
	'note_share_quiz' => '分享了你的竞猜 <a href="\\1" target="_blank">\\2</a>',
	'share_album' => '分享了一个相册',
	...
	'feed_task_credit' => '{actor} 完成了有奖任务 {task}，领取了 {credit} 个奖励竞猜',
	...
	'feed_quiz_password' => '{actor} 发表了新加密竞猜 {subject}',
	'feed_quiz' => '{actor} 发表了新竞猜',
	...
	'take_part_in_the_quiz' => '{actor} 参与了 {touser} 的{reward}竞猜 <a href="{url}" target="_blank">{subject}</a>',
	'publish_key_in_the_quiz' => '{actor} 公布了竞猜 <a href="{url}" target="_blank">{subject}</a>的答案，答案是{key}',
	'publish_key_in_the_quiz2' => '{actor} 公布了竞猜 <a href="{url}" target="_blank">{subject}</a>的答案，本期竞猜流失，所有金币已返还给参与用户。',
	'publish_key_in_the_quiz3' => '{actor} 公布了竞猜 <a href="{url}" target="_blank">{subject}</a>的答案，答案是{key}.<br><br><br>参与人数{attend}人,中奖人数 {win}人，每人获得奖池{precost}金币<br>恭喜{touser}成为本次竞猜的大赢家',
	'publish_key_in_the_quiz4' => '{actor} 公布了竞猜 <a href="{url}" target="_blank">{subject}</a>的答案，答案是{key}.<br><br><br>参与人数{attend}人,很不幸本期没有人获胜，大家要加油哟！',
	...
	'feed_add_attachsize' => '{actor} 用 {credit} 个竞猜兑换了 {size} 附件空间，可以上传更多的图片啦(<a href="cp.php?ac=credit&op=addsize">我也来兑换</a>)',
