...
$_SGLOBAL['msglang'] = array(
	...
	//network.php
	'points_deducted_yes_or_no' => '本次操作将扣减您 \\1 个金币，\\2 个信用值，确认继续？<br><br><a href="\\3" class="submit">继续操作</a> &nbsp; <a href="javascript:history.go(-1);" class="button">取消</a>',
	'points_search_error' => "您现在的金币或信用值不足，无法完成本次搜索",
	...
	'send_result_3' => '未找到相应的邀请心情, 邮件重发失败.',
	'there_is_no_record_of_invitation_specified' => '您指定的邀请心情不存在',
	...
	'integral_inadequate' => "您现在的金币 \\1 不足以完成本次操作。本操作将需要金币: \\2",
	'experience_inadequate' => "您现在的信用值\\1 不足以完成本次操作。本操作将需要信用值: \\2",
	...
	'voting_not_enough_credit' => '对不起，你的金币不足以投注',
	...
	'average_reward_can_not_exceed' => '平均每人悬赏最高不能超过\\1个金币',
	...
	'credits_exchange_invalid' => '兑换的金币方案有错，不能进行兑换，请返回修改。',
	'credits_transaction_amount_invalid' => '您要转账或兑换的金币数量输入有误，请返回修改。',
	'credits_password_invalid' => '您没有输入密码或密码错误，不能进行金币操作，请返回。',
	'credits_balance_insufficient' => '对不起，您的金币余额不足，兑换失败，请返回。',
	...
	'integral_convertible_unopened' => '系统目前没有开启金币兑换功能',
	...
	'invite_error' => '无法获取好友邀请码，请确认您是否有足够的金币来进行本操作',
	...
	'showcredit_error' => '填写的数字需要大于0，并且小于您的金币数，请确认',
	'showcredit_fuid_error' => '您指定的用户还不是你的好友，请确认',
	'showcredit_do_success' => '您已经成功增加上榜金币，赶快查看自己的最新排名吧',
	'showcredit_friend_do_success' => '您已经成功赠送好友上榜金币，好友会收到通知的',
	...
	'credit_is_not_enough' => '您的金币不够购买此道具',
	'not_enough_storage' => '道具库存量不足，下次补给时间是 \\1',
	'magicbuy_success' => '道具购买成功，花费金币 \\1',
	'magicbuy_success_with_experence' => '道具购买成功，花费金币 \\1, 增加信用 \\2',
	...
	'magicuse_bad_credit_given' => '您输入的金币数无效',
	'magicuse_not_enough_credit' => '您输入的金币数超过所当前拥有的金币',
	'magicuse_bad_chunk_given' => '您输入的单份金币数无效',
	'magic_gift_already_given_out' => '红包已经被领完了',
	'magic_got_gift' => '您已经领取到了红包：增加 \\1 个金币',
