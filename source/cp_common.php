...
if($op == 'logout') {
	...
	showmessage('security_exit', 'space.php?do=feed', 1, array($ucsynlogout));
	...
	if(!in_array($_GET['idtype'], array('picid', 'blogid', 'albumid', 'tagid', 'tid', 'sid', 'uid', 'pid', 'eventid', 'comment', 'post', 'quizid')) || empty($_GET['id'])) {
